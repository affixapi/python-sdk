...
> TimeOffEntries20230301Response xhr_time_off_entries20230301(start_date, end_date)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Time off entries
        api_response = api_instance.xhr_time_off_entries20230301(start_date, end_date)
        pprint(api_response)
    except openapi_client.ApiException as e:
...
> Timesheets20230301Response xhr_timesheets20230301(start_date, end_date)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Timesheets
        api_response = api_instance.xhr_timesheets20230301(start_date, end_date)
        pprint(api_response)
    except openapi_client.ApiException as e:
